	...
	*/
	...
	class ezSQL_mysqli extends ezSQLcore
	{
		...
		*/
		...
		function ezSQL_mysqli($dbuser='root', $dbpassword='', $dbname='spk_ahp', $dbhost='127.0.0.1', $encoding='')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function quick_connect($dbuser='root', $dbpassword='', $dbname='spk_ahp', $dbhost='127.0.0.1', $dbport='3306', $encoding='')
		{
			$return_val = false;
		...
		*/
		...
		function connect($dbuser='root', $dbpassword='', $dbhost='127.0.0.1', $dbport=3306)
		{
		...
		*/
		...
		function select($dbname='spk_ahp', $encoding='')
		{
			global $ezsql_mysqli_str; $return_val = false;
